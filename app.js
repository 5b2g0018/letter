...
const CHAPTERS = {
    ...
    2: {
        ...
        message: `九兔讓我們相遇，或許從我把薯條的文打成妳的文那一刻開始，就已經注定了我們會認識。

這幾個月最開心的事情之一，就是能夠認識你們、認識妳。其實以前的我，是一個從來不太會在網路上跟別人社交的人，也很少主動去認識陌生人。可是也不知道為什麼，遇到妳們之後，好像就慢慢變得不一樣了。

從一開始不太敢在群組裡說話，到後來會一起聊天、一起開玩笑，再到現在可以把很多心裡的話告訴彼此。回頭想想，真的覺得這一切很不可思議。

明明我們原本只是網路上完全不認識的陌生人，生活也在不同的地方，卻能在短短幾個月裡，慢慢走進彼此的生活，也慢慢變成我很珍惜、我很在乎的人。
...
所以我一直覺得，能遇見你們真的很幸運。`,
        ...
        photoCaption: '完璧じゃなくていい。一生懸命やれば、それでいい',
        date: '2026.09.05',
        sender: '松鼠 🐿️',
        showLovelys: false
    },
...
雖然我們從來沒有見過面，也沒有真正出現在彼此的現實生活裡，但不知道從什麼時候開始，哥真的已經把妳當成自己的妹妹了。知道妳在家裡經歷過的一些事情，也因為發現我們其實有很多地方都很像，所以有時候真的會特別希望妳可以好好的。
...
我沒有辦法給妳親筆信，就算真的寫了，也沒辦法親手交到妳手上（妳離我太遠了哈哈哈，所以最後就想說，那我乾脆自己寫一個網站送給妳。
